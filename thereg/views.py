...
from thereg.models import Member1, Member2, Member3, Member4
...
def members(request):
    member4 = Member4.objects.all()
    member3 = Member3.objects.all()
    member2 = Member2.objects.all()
    member1 = Member1.objects.all()

    return render(request, 'thereg/members.html', {"member4": member4, "member3": member3, "member2": member2, "member1": member1})
