...
class Post(models.Model):
    ...
    image = models.ImageField(upload_to='media/img',blank=True, default="media/img/transparent photo .jpg")
    image_1 = models.ImageField(upload_to='media/img',blank=True, default='media/img/transparent photo .jpg')
    image_2 = models.ImageField(upload_to='media/img',blank=True, default='media/img/transparent photo .jpg')
    image_3 = models.ImageField(upload_to='media/img',blank=True, default='media/img/transparent photo .jpg')
