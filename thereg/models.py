...
class Post(models.Model):
    ...
    image_1 = models.ImageField(upload_to='media/img',blank=True)
    image_2 = models.ImageField(upload_to='media/img',blank=True)
    image_3 = models.ImageField(upload_to='media/img',blank=True)
